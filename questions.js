...
chemistry:[
        ...
        {question:`Compounds that have the same molecular formula but different structures are said to be `, option:["isomeric","isotopes","polymeric","allotropic"," B"]},//NO ANSWER
        ...
        {question:`The maximum number of electrons that can be accomodated in the shell having the principal quantum number 3 is`, option:["3","9","18","32","B "]},
        {question:`Methanol is obtained from wood by`, option:["esterification","destructive distillation","combustion","fractional distillation","C "]},
        {question:`Study carfully the reaction represented by the equation 2H<sub>2</sub>O<sub>2(l)</sub> &#8594; O<sub>2(g)</sub>+2H<sub>2</sub>O<sub>(l)</sub> which of the following will not increase the reaction rate?`, option: ["Heating the hydrogen peroxide", "Adding a pinch of MnO<sub>2</sub> to the reactant","Increasing the concentration of the H<sub>2</sub>O<sub>2</sub>","Adding water to the reactent","B "]},
        {question:`Which of the following processes is a physical reaction? `, option:["Electrolysis","Hydrolysis","Allotropic change","Neutralization","D "]},
        ...
        {question:`"The rate of reaction is proportional to the number of effective collisions occuring per second between the reactants". This statement is associated with the`, option:["Kinetic theory","rate law","atomic theory","collision theory"," C"]},
        {question:`In the reaction represented by the following equation; 2H<sub>2</sub>S<sub>(g)</sub> +SO<sub>2</sub> &#8594;2H<sub>2</sub>O<sub>(l)</sub>+3S<sub(s)</sub>, SO<sub>2</sub> is acting as `, option:["a reducing agent","an oxidizing agent","a dehydrating agent","a bleaching agent","D "]},
        {question:`When iron rust, it undergoes`, option:["chemical decomposition","hydrolysis","redox reaction","combustion","B "]},
        {question: `The following salt are readily soluble in water except:`, option: ["Na<sub>2</sub>CO<sub>3</sub>", "Pb(NO<sub>3</sub>)<sub>2</sub>", "KCl","FeSO<sub>4</sub>","C "]},
        ...
        {question:`The ionic radii of metals are usually`, option:["greater than their atomic radii","unaffected by the charge on the ion","less than their atomic radii","greater than those of non-metals","D "]},
        ...
        {question:`If a reaction is said to be exothermic, which of the following statements is a correct deduction from the information?`, option:["The reaction vessel gets hotter as the reaction proceeds","&#9651;H for the reaction is positive","The rate of reaction increases with time","The activation energy of the reaction is high","C "]},
        {question:`Which of the following pH values is likely to be that of a slighly alkaline solution?`, option:["2","5","7","8","B "]},
        {question:`Which of the following minerals contains fluorine as one of its constituent elements?`, option:["Cryolite","Bauxite","Potash alum","Kaolin","B "]},
        {question:`The product of the reaction between propanoic acid and ethanol is `, option:["ethylpropanoate","ethylethanoate","methylpropanoate","propylethanoate","A"]},
        {question:`Which of the following account for the difference in the mode of conduction of electricity by metals and aqueous salt solutions?`, option:["electrons are present in metals but not in salt solutions","Metals are conductor while salts are electrolytes","electricity is carried by mobile electrons in metals but by ions in aqueous salts solution","salts ionize in aqueous solution while metals do not."," D"]},
        {question:`Starch undergoes complete hydrolysis to produce `, option:["maltose","lactose","fructose","glucose","A "]},
        {question:`Which of the following solids has a network structure?`, option:["Diamond","Iodine","Sulphur","Graphite"," A"]},
        ...
        {question:`Carbon is often deposited in the exhaust-pipe of cars because of the`, option:["presence of carbon in petrol","dehydrogenation of petrol","Incomplete combustion of petrol","presense of additives in petrol"," D"]},
        {question:`Sulphur burns in air to form:`, option:["an acidic oxide","a basic oxide","an amphoteric oxide","a neutral oxide","C "]},
        {question:`Chlorine is used in water treatment as:`, option:["a germicide","a decolourizing agent","an antioxidant","a coagulating agent","D "]},
